...
function LoneSchemaDefinitionRule(context) {
  var _ref, _ref22, _oldSchema$astNode;
  const oldSchema = context.getSchema();
  const alreadyDefined = (_ref = (_ref22 = (_oldSchema$astNode = oldSchema === null || oldSchema === void 0 ? void 0 : oldSchema.astNode) !== null && _oldSchema$astNode !== void 0 ? _oldSchema$astNode : oldSchema === null || oldSchema === void 0 ? void 0 : oldSchema.getQueryType()) !== null && _ref22 !== void 0 ? _ref22 : oldSchema === null || oldSchema === void 0 ? void 0 : oldSchema.getMutationType()) !== null && _ref !== void 0 ? _ref : oldSchema === null || oldSchema === void 0 ? void 0 : oldSchema.getSubscriptionType();
...
var curriedDevtoolsExchange = function(ref) {
  ...
  return function(ref2) {
    ...
    return function(ops$) {
      return pipe(ops$, onPush(handleOperation({
        client,
        sendMessage
      })), forward, onPush(handleResult({
        client,
        sendMessage
      })));
    };
  ...
  "execute-query": function(ref) {
    ...
    return function(message) {
      ...
      var op = client.createRequestOperation(isMutation ? "mutation" : "query", {
        key: (x = JSON.stringify(message.query), function(h, x2) {
          h |= 0;
          for (var i = 0, l = 0 | x2.length; i < l; i++) {
            h = (h << 5) + h + x2.charCodeAt(i);
          }
          return h;
        }(5381, x) >>> 0),
...
//# sourceMappingURL=@urql_devtools.js.map
